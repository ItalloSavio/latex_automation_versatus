% Layout D — loaded by styles/versatus-covers.sty.
% Select it with:  \renewcommand{\VSCoverOption}{LayoutD}
% Defines \VSCoverLayoutD. This is NOT a package: the package owns the preamble.


% --- Comando Principal da Capa ---
\newcommand{\VSCoverLayoutD}{%
\begin{titlepage}
\thispagestyle{empty}
\noindent
